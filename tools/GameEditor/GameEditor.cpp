...
// 唯一的一个 CAppieDataToolsApp 对象

CGameEditorApp theApp;

// CAppieDataToolsApp 初始化
...
BOOL CGameEditorApp::InitInstance()
{
	...
	// 加载配置文件
	EditorConfig::Instance()->loadConfig();
